...
public class NWaySetAssociativeCache<K, V, M> implements Cache<K, V, M>{
    ...
    private final ReplacementAlgo<K, V, M> replacementAlgorithm;

    public NWaySetAssociativeCache(int setSize, int entrySize, ReplacementAlgo<K, V, M> replacementAlgorithm) {
        this.setSize = setSize;
        this.entrySize = entrySize;
        this.replacementAlgorithm = replacementAlgorithm;
        this.cacheContents = (List<CacheElement<K, V, M>>[]) new CacheElement[this.setSize];
    }
